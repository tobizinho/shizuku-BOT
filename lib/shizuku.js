 ...
 try {
  ...
  switch (command) {
   ...
   case 'ban':
    ...
    participants = mek.message[type].contextInfo?.participant !== undefined ? message === "@s.whatsapp.net": mek.message[type].contextInfo.participant ? message.replace(/[- +@]/g, '') + "@s.whatsapp.net": 'a'
    reply(participants);
